...
export function BedIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function BathIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function StarIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="currentColor" viewBox="0 0 20 20">
...
export function ChevronDownIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
...
export function WhatsAppIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
...
// Lucide arrow-right and arrow-left, copied verbatim from lucide-react v0.574
// (the version used in compliance_tracker). Same paths, same stroke-width 2,
// same round caps/joins — visually identical to <ArrowRight /> / <ArrowLeft />
// from `lucide-react`, without the dependency.
...
export function ShieldIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function KeyIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function BuildingIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function ClockIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function HomeIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function CurrencyIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function UserGroupIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function WrenchIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function SofaIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg {...props} className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
